...
@Injectable()
export default class RealEstateDetailResolver extends BaseEntityResolver<
    RealEstateCustomFieldsFragment
    > {
    constructor(router: Router, dataService: DataService) {
        super(
            ...
            (id) =>
                dataService.query<GetRealEstateQuery, GetRealEstateQueryVariables>(GET_REAL_ESTATE, {
                    id: id
                })
